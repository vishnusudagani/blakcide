...
const checks = [
  { path: '/', type: 'text/html', has: ['Blaksyd', 'building meaningful conversations', 'blaksyd-entity-index.json', 'Search Blaksyd', 'href="/search/"', 'msapplication-config', '/browserconfig.xml', '/organization.jsonld', '/humans.json', '/blaksyd-citations.json', '/blaksyd-openapi.yaml', '/.well-known/security.txt', 'Vishnu Sudagani, co-founder and CEO', 'Dr. Sindhuu Devarakonda, co-founder and CPO'], linkHeader: true },
  { path: '/answers/', type: 'text/html', has: ['Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda', 'blaksyd-answers.json'] },
  { path: '/search/?q=who%20founded%20Blaksyd', type: 'text/html', has: ['Search Blaksyd', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda', 'llms.json'] },
  { path: '/llms.txt', type: 'text/plain', has: ['building meaningful conversations', 'Vishnu Sudagani', 'Sindhuu Devarakonda', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml', 'opensearch.xml', 'security.txt'] },
  { path: '/.well-known/llms.txt', type: 'text/plain', has: ['building meaningful conversations', 'Founders', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml'] },
  ...
  { path: '/llms-full.txt', type: 'text/plain', has: ['# Blaksyd', 'Full Reference', 'building meaningful conversations'] },
  { path: '/.well-known/llms-full.txt', type: 'text/plain', has: ['# Blaksyd', 'Full Reference', 'building meaningful conversations'] },
  { path: '/ai.txt', type: 'text/plain', has: ['building meaningful conversations', 'blaksyd-entity-index.json', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml'] },
  { path: '/.well-known/ai.txt', type: 'text/plain', has: ['building meaningful conversations', 'Founder entity files', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml'] },
  { path: '/humans.txt', type: 'text/plain', has: ['Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'building meaningful conversations'] },
  { path: '/.well-known/humans.txt', type: 'text/plain', has: ['Vishnu Sudagani', 'Sindhuu Devarakonda'] },
  { path: '/humans.json', type: 'application/json', json: true, has: ['Blaksyd team', 'Blaksyd LLP', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'organization.jsonld'] },
  { path: '/.well-known/humans.json', type: 'application/json', json: true, has: ['Well-known structured team', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'organization.jsonld'] },
  { path: '/answers.md', type: 'text/markdown', has: ['# Blaksyd Answers', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda', 'https://blaksyd.com/blaksyd-answers.json'] },
  { path: '/.well-known/answers.md', type: 'text/markdown', has: ['# Blaksyd Answers', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda', 'https://blaksyd.com/answers.md'] },
  { path: '/answers.jsonld', type: 'application/ld+json', json: true, has: ['FAQPage', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda'] },
  { path: '/.well-known/answers.jsonld', type: 'application/ld+json', json: true, has: ['FAQPage', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda'] },
  { path: '/blaksyd-answers.json', type: 'application/json', json: true, has: ['Who founded Blaksyd?', 'building meaningful conversations', 'Vishnu Sudagani', 'organization.jsonld', 'humans.json'] },
  { path: '/.well-known/blaksyd-answers.json', type: 'application/json', json: true, has: ['Who founded Blaksyd?', 'building meaningful conversations', 'Vishnu Sudagani', 'organization.jsonld', 'humans.json'] },
  { path: '/blaksyd-citations.json', type: 'application/json', json: true, has: ['Blaksyd citation map', 'claim-to-source citation map', 'building meaningful conversations', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda, also known as Sindhuu Devarakonda, is the co-founder and CPO of Blaksyd.', 'Do not describe Minit as therapy.'] },
  ...
  { path: '/blaksyd-knowledge-graph.jsonld', type: 'application/ld+json', json: true, has: ['Blaksyd', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda'] },
  { path: '/organization.jsonld', type: 'application/ld+json', json: true, has: ['Blaksyd LLP', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'https://blaksyd.com/#organization'] },
  { path: '/.well-known/organization.jsonld', type: 'application/ld+json', json: true, has: ['Blaksyd LLP', 'building meaningful conversations', 'Blaksyd founder Vishnu Sudagani', 'Blaksyd founder Dr. Sindhuu Devarakonda', 'blaksyd-entity-index.json'] },
  ...
  { path: '/opensearch.xml', type: 'application/opensearchdescription+xml', has: ['opensearch-suggestions.json', 'https://blaksyd.com/search/?q={searchTerms}', 'building meaningful conversations', 'Blaksyd'] },
  { path: '/opensearch-suggestions.json', type: 'application/x-suggestions+json', json: true, has: ['Search Blaksyd', 'building meaningful conversations', 'https://blaksyd.com/search/', 'Blaksyd Answers', 'https://blaksyd.com/answers/', 'Vishnu Sudagani Blaksyd', 'Sindhuu Devarakonda Blaksyd'] },
  ...
  { path: '/rss.xml', type: 'application/xml', has: ['Blaksyd Answers', 'https://blaksyd.com/answers/', 'Blaksyd Answer Graph JSON-LD', 'building meaningful conversations', 'Vishnu Sudagani'] },
  ...
  { path: '/site.webmanifest', type: 'application/manifest+json', json: true, has: ['building meaningful conversations', 'Blaksyd Answers', 'What is Blaksyd?', 'Dr. Sindhuu Devarakonda'] },
  { path: '/manifest.json', type: 'application/manifest+json', json: true, has: ['building meaningful conversations', 'Search Blaksyd', 'Blaksyd Founders', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda'] },
