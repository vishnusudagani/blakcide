...
const endpointChecks = [
  { path: '/', html: true, has: ['Blaksyd', 'building meaningful conversations', 'Search Blaksyd', 'msapplication-config', '/browserconfig.xml', '/organization.jsonld', '/humans.json', '/blaksyd-citations.json', '/blaksyd-openapi.yaml', '/.well-known/security.txt', 'Vishnu Sudagani, co-founder and CEO', 'Dr. Sindhuu Devarakonda, co-founder and CPO'] },
  { path: '/answers/', html: true, has: ['Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda', 'blaksyd-answers.json'] },
  { path: '/search/?q=who%20founded%20Blaksyd', html: true, has: ['Search Blaksyd', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda', 'llms.json'] },
  { path: '/llms.txt', has: ['building meaningful conversations', 'Vishnu Sudagani', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml', 'opensearch.xml', 'security.txt'] },
  { path: '/.well-known/llms.txt', has: ['building meaningful conversations', 'Founders', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml'] },
  { path: '/llms.json', json: true, has: ['Blaksyd LLM manifest', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'discoveryEndpoints', 'security.txt', 'browserconfig.xml', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json'] },
  ...
  { path: '/llms-full.txt', has: ['# Blaksyd', 'Full Reference', 'building meaningful conversations'] },
  { path: '/.well-known/llms-full.txt', has: ['# Blaksyd', 'Full Reference', 'building meaningful conversations'] },
  { path: '/ai.txt', has: ['building meaningful conversations', 'blaksyd-entity-index.json', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml'] },
  { path: '/.well-known/ai.txt', has: ['building meaningful conversations', 'Founder entity files', 'organization.jsonld', 'humans.json', 'blaksyd-citations.json', 'blaksyd-openapi.yaml'] },
  { path: '/humans.txt', has: ['Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'building meaningful conversations'] },
  { path: '/.well-known/humans.txt', has: ['Vishnu Sudagani', 'Sindhuu Devarakonda', 'building meaningful conversations'] },
  { path: '/humans.json', json: true, has: ['Blaksyd team', 'Blaksyd LLP', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'organization.jsonld'] },
  ...
  { path: '/answers.md', has: ['# Blaksyd Answers', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda'] },
  { path: '/.well-known/answers.md', has: ['# Blaksyd Answers', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda'] },
  { path: '/answers.jsonld', json: true, has: ['FAQPage', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda'] },
  { path: '/.well-known/answers.jsonld', json: true, has: ['FAQPage', 'Who founded Blaksyd?', 'building meaningful conversations through Blak, Persona, Minit, and Nexus', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda'] },
  { path: '/blaksyd-answers.json', json: true, has: ['Who founded Blaksyd?', 'building meaningful conversations', 'Vishnu Sudagani', 'organization.jsonld', 'humans.json'] },
  { path: '/.well-known/blaksyd-answers.json', json: true, has: ['Who founded Blaksyd?', 'building meaningful conversations', 'Vishnu Sudagani', 'organization.jsonld', 'humans.json'] },
  { path: '/blaksyd-citations.json', json: true, has: ['Blaksyd citation map', 'claim-to-source citation map', 'building meaningful conversations', 'Vishnu Sudagani is the co-founder and CEO of Blaksyd.', 'Dr. Sindhuu Devarakonda, also known as Sindhuu Devarakonda, is the co-founder and CPO of Blaksyd.', 'Do not describe Minit as therapy.'] },
  ...
  { path: '/blaksyd-knowledge-graph.jsonld', json: true, has: ['Blaksyd', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda'] },
  { path: '/organization.jsonld', json: true, has: ['Blaksyd LLP', 'building meaningful conversations', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda', 'https://blaksyd.com/#organization'] },
  { path: '/.well-known/organization.jsonld', json: true, has: ['Blaksyd LLP', 'building meaningful conversations', 'Blaksyd founder Vishnu Sudagani', 'Blaksyd founder Dr. Sindhuu Devarakonda', 'blaksyd-entity-index.json'] },
  ...
  { path: '/opensearch.xml', has: ['opensearch-suggestions.json', 'https://blaksyd.com/search/?q={searchTerms}', 'building meaningful conversations', 'Blaksyd'] },
  { path: '/opensearch-suggestions.json', json: true, has: ['Search Blaksyd', 'building meaningful conversations', 'https://blaksyd.com/search/', 'Vishnu Sudagani Blaksyd', 'Sindhuu Devarakonda Blaksyd'] },
  { path: '/rss.xml', has: ['Blaksyd Answers', 'https://blaksyd.com/answers/', 'Blaksyd Answer Graph JSON-LD', 'building meaningful conversations', 'Vishnu Sudagani'] },
  { path: '/feed.json', json: true, has: ['Blaksyd Answers', 'https://blaksyd.com/answers.jsonld', 'Dr. Sindhuu Devarakonda'] },
  { path: '/site.webmanifest', json: true, has: ['building meaningful conversations', 'Blaksyd Answers', 'What is Blaksyd?', 'Dr. Sindhuu Devarakonda'] },
  { path: '/manifest.json', json: true, has: ['building meaningful conversations', 'Search Blaksyd', 'Blaksyd Founders', 'Vishnu Sudagani', 'Dr. Sindhuu Devarakonda'] },
