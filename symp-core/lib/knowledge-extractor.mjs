...
const EXTRACTOR_SYSTEM = [
    ...
    '- Map each fact to the BEST (area, key) above. If it fits NO fixed field, ALWAYS create it under area "other" with a short snake_case key you invent (e.g. other: launch_date, other: favourite_car, other: company_name) — NEVER drop a real detail just because no field matches. The profile is open-ended; keep adding to it.',
