...
const MEMORY_SYSTEM = [
    ...
    '- STAY CURRENT: always reflect what is going on with them LATELY — recent plans, events, and developments from the latest exchange must make it in. Lead with who they are + what is current; let older, less-active details sit lower. The memory should never feel out of date.',
    '- Be concise but complete: UNDER 2000 characters, plain text (short lines). No headings, no preamble, no fluff.',
